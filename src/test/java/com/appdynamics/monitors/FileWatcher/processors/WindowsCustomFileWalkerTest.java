...
public class WindowsCustomFileWalkerTest {
    ...
    public void visitDirectoryAndContentsRecursivelyNoMatches() throws Exception {
        ...
        for (Path p : paths) {
            Assert.assertTrue(!fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), p, "A\\")));
        }
    }
    ...
    public void visitDirectoryAndContentsRecursively() throws Exception {
        ...
        for (Path p : paths) {
            Assert.assertTrue(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), p, "A\\D\\")));
        }
    }
    ...
    public void visitFilesWithinADirectoryRegex() throws Exception {
        ...
        Assert.assertTrue(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), a, "A\\D\\")));
        Assert.assertTrue(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), b, "A\\D\\")));
        Assert.assertFalse(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), c, "A\\D\\")));
    }
    ...
    public void visitFileWithinADirectory() throws Exception {
        ...
        Assert.assertEquals(1, fileMetrics.size());
        Assert.assertTrue(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), a, "A\\D\\")));
        Assert.assertFalse(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), b, "A\\D\\")));
        Assert.assertFalse(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), c, "A\\D\\")));
    }
    ...
    public void visitFilesWithRegexesWithinADirectoryWithIntermediateRegexes() throws Exception {
        ...
        Assert.assertTrue(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), b, "A\\D\\")));
        Assert.assertFalse(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), c, "A\\D\\")));
        Assert.assertFalse(fileMetrics.containsKey(getFormattedDisplayName(pathToProcess.getDisplayName(), d, "A\\D\\")));
    }
