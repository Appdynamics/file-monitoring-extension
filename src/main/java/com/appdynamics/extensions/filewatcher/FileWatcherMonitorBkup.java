 ...
 */
public class FileWatcherMonitorBkup extends AManagedMonitor {

    protected final Logger logger = Logger.getLogger(FileWatcherMonitorBkup.class.getName());
    ...
    private static String getImplementationVersion() {
        return FileWatcherMonitorBkup.class.getPackage().getImplementationTitle();
    }
}
